...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["demo-pages-tables-tbl-bootstrap-tbl-bootstrap-module"], {
  ...
  function srcAppDemoPagesTablesTblBootstrapTblBootstrapRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      children: [{
        ...
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | tbl-border-tbl-border-module */
          "tbl-border-tbl-border-module").then(__webpack_require__.bind(null,
          /*! ./tbl-border/tbl-border.module */
          "./src/app/demo/pages/tables/tbl-bootstrap/tbl-border/tbl-border.module.ts")).then(function (module) {
            return module.TblBorderModule;
          });
        }
      }, {
        path: 'bt-sizing',
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | tbl-sizing-tbl-sizing-module */
          "tbl-sizing-tbl-sizing-module").then(__webpack_require__.bind(null,
          /*! ./tbl-sizing/tbl-sizing.module */
          "./src/app/demo/pages/tables/tbl-bootstrap/tbl-sizing/tbl-sizing.module.ts")).then(function (module) {
            return module.TblSizingModule;
          });
        }
      }, {
        path: 'bt-styling',
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | tbl-styling-tbl-styling-module */
          "tbl-styling-tbl-styling-module").then(__webpack_require__.bind(null,
          /*! ./tbl-styling/tbl-styling.module */
          "./src/app/demo/pages/tables/tbl-bootstrap/tbl-styling/tbl-styling.module.ts")).then(function (module) {
            return module.TblStylingModule;
          });
        }
      }]
    }];
    ...
    TblBootstrapRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  function srcAppDemoPagesTablesTblBootstrapTblBootstrapModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    TblBootstrapModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
