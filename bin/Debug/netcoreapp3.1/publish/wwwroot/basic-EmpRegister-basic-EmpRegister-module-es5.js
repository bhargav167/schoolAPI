...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["basic-EmpRegister-basic-EmpRegister-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppDemoUiElementsUiBasicBasicEmpRegisterBasicEmpRegisterComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDemoUiElementsUiBasicBasicEmpRegisterBasicEmpRegisterRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BasicEmpRegisterRoutingModule", function () {
      return BasicEmpRegisterRoutingModule;
    });
    /* harmony import */
    ...
    var _basic_EmpRegister_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./basic-EmpRegister.component */
    ...
    var BasicEmpRegisterRoutingModule = function BasicEmpRegisterRoutingModule() {
      _classCallCheck(this, BasicEmpRegisterRoutingModule);
    };

    BasicEmpRegisterRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppDemoUiElementsUiBasicBasicEmpRegisterBasicEmpRegisterComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDemoUiElementsUiBasicBasicEmpRegisterBasicEmpRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BasicEmpRegisterComponent", function () {
      return BasicEmpRegisterComponent;
    });
    /* harmony import */
    ...
    var BasicEmpRegisterComponent = /*#__PURE__*/function () {
      function BasicEmpRegisterComponent(fb, _classLevel, _empServices, toastr) {
        _classCallCheck(this, BasicEmpRegisterComponent);

        this.fb = fb;
        this._classLevel = _classLevel;
        this._empServices = _empServices;
        this.toastr = toastr; // maps the local data column to fields property
      ...
      _createClass(BasicEmpRegisterComponent, [{
        key: "ngOnInit",
        ...
        value: function getLastId() {
          ...
          this._empServices.getLastEmpRegisterId().subscribe(function (data) {
            _this.empData = data;

            if (_this.empData == null) {
              _this.RegistrationNo = 1;
            }

            _this.RegistrationNo = data.registrationNo;
            _this.RegistrationNo = parseInt(_this.RegistrationNo) + 1;
          });
        }
      }, {
        key: "LevelChange",
        ...
        value: function register() {
          ...
          if (this.registerStudent.valid) {
            ...
            this._empServices.register(this.empRegister).subscribe(function () {
              _this3.toastr.success('Employee Registration Done!', 'Data Saved');

              _this3.registerStudent.reset();

              _this3.btnLoader = false;

              _this3.getLastId();

              _this3.createRegisterForm();
            }, function (error) {
              _this3.toastr.error('Employee Registration Failed!', 'Problem in saving Data', error);
    ...
    BasicEmpRegisterComponent.ctorParameters = function () {
      return [{
    ...
    BasicEmpRegisterComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-basic-EmpRegister',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./basic-EmpRegister.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/demo/ui-elements/ui-basic/basic-EmpRegister/basic-EmpRegister.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./basic-EmpRegister.component.css */
      "./src/app/demo/ui-elements/ui-basic/basic-EmpRegister/basic-EmpRegister.component.css"))["default"]]
  ...
  /***/
  function srcAppDemoUiElementsUiBasicBasicEmpRegisterBasicEmpRegisterModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BasicEmpRegisterModule", function () {
      return BasicEmpRegisterModule;
    });
    /* harmony import */
    ...
    var _basic_EmpRegister_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./basic-EmpRegister-routing.module */
    "./src/app/demo/ui-elements/ui-basic/basic-EmpRegister/basic-EmpRegister-routing.module.ts");
    /* harmony import */
    ...
    var _syncfusion_ej2_angular_dropdowns__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! @syncfusion/ej2-angular-dropdowns */
    "./node_modules/@syncfusion/ej2-angular-dropdowns/@syncfusion/ej2-angular-dropdowns.js");

    var BasicEmpRegisterModule = function BasicEmpRegisterModule() {
      _classCallCheck(this, BasicEmpRegisterModule);
    };

    BasicEmpRegisterModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], src_app_theme_shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"], ngx_bootstrap_datepicker__WEBPACK_IMPORTED_MODULE_6__["BsDatepickerModule"].forRoot(), ngx_toastr__WEBPACK_IMPORTED_MODULE_7__["ToastrModule"].forRoot(), _basic_EmpRegister_routing_module__WEBPACK_IMPORTED_MODULE_5__["BasicEmpRegisterRoutingModule"], _syncfusion_ej2_angular_dropdowns__WEBPACK_IMPORTED_MODULE_8__["MultiSelectAllModule"]],
      declarations: [_basic_EmpRegister_component__WEBPACK_IMPORTED_MODULE_3__["BasicEmpRegisterComponent"]]
    })], BasicEmpRegisterModule);
    /***/
  }
}]);
//# sourceMappingURL=basic-EmpRegister-basic-EmpRegister-module-es5.js.map