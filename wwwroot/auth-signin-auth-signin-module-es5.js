...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["auth-signin-auth-signin-module"], {
  ...
  function srcAppDemoPagesAuthenticationAuthSigninAuthSigninComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_services_AuthServices_Auth_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    var AuthSigninComponent = /*#__PURE__*/function () {
      function AuthSigninComponent(_authServices, _router, toastr) {
      ...
      _createClass(AuthSigninComponent, [{
        ...
        value: function ngOnInit() {
          ...
          if (localStorage.getItem('token') != null) this._router.navigateByUrl('/layout/fixed');
        }
      }, {
        key: "login",
        value: function login(form) {
          ...
          this._authServices.login(form.value, this.selectedRole).subscribe(function (res) {
            localStorage.setItem("token", res.token);
            localStorage.setItem("role", res.selectedRole);
            localStorage.setItem("Id", res.Id);

            if (_this.selectedRole == 'Admin') {
              _this._router.navigateByUrl('/layout/fixed');
            }

            if (_this.selectedRole == 'Student') {
              _this._router.navigateByUrl('/layout/StuDash');
            }
          }, function (err) {
            if (err.status == 400) {
              _this.toastr.error("Opps! Incorrect UserName & Password");

              _this.btnLoader = false;
            }

            if (err.status == 401) {
              _this.toastr.error("Opps! You Are Not Authorized For This Role.");
        ...
        key: "GetSelectedRole",
        value: function GetSelectedRole(role) {
          this.selectedRole = '';
          this.selectedRole = role;
  ...
  function srcAppDemoPagesAuthenticationAuthSigninAuthSigninModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AuthSigninModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _auth_signin_routing_module__WEBPACK_IMPORTED_MODULE_3__["AuthSigninRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpClientModule"]],
