...
namespace sKul.API.Migrations
{
    ...
    [Migration("20210412143247_homework")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("sKul.API.Models.AcadmicModel.SubjectGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("sKul.API.Models.EmployeePhotos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("sKul.API.Models.Homework.Homework", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<string>("AttachDocxname")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");
            ...
            modelBuilder.Entity("sKul.API.Models.EmployeePhotos", b =>
                {
                    b.HasOne("sKul.API.Models.Employee", "emp")
                        .WithMany()
                        .HasForeignKey("empId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
