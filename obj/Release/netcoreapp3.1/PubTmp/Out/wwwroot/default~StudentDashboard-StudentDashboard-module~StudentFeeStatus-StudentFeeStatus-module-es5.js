...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~StudentDashboard-StudentDashboard-module~StudentFeeStatus-StudentFeeStatus-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppDemoPagesLayoutStudentFeeStatusStudentFeeStatusComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDemoPagesLayoutStudentFeeStatusStudentFeeStatusRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "StudentFeeStatusRoutingModule", function () {
      return StudentFeeStatusRoutingModule;
    });
    /* harmony import */
    ...
    var _StudentFeeStatus_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./StudentFeeStatus.component */
    ...
    var StudentFeeStatusRoutingModule = function StudentFeeStatusRoutingModule() {
      _classCallCheck(this, StudentFeeStatusRoutingModule);
    };

    StudentFeeStatusRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppDemoPagesLayoutStudentFeeStatusStudentFeeStatusComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDemoPagesLayoutStudentFeeStatusStudentFeeStatusComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "StudentFeeStatusComponent", function () {
      return StudentFeeStatusComponent;
    });
    /* harmony import */
    ...
    var src_app_services_StudentServices_Student_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    var StudentFeeStatusComponent = /*#__PURE__*/function () {
      function StudentFeeStatusComponent(_feeModule, _route, _toster) {
        _classCallCheck(this, StudentFeeStatusComponent);
      ...
      _createClass(StudentFeeStatusComponent, [{
        key: "ngOnInit",
        ...
        value: function getStudentDetails() {
          ...
          this._feeModule.getStudentDetails(this.userId).subscribe(function (res) {
            _this.stuDetails = res;
            _this.Id = _this.stuDetails.Id;
            _this.stander = _this.stuDetails.standers;
            _this.section = _this.stuDetails.classsection;

            _this.loadFeeStaus(_this.Id, _this.stander, _this.section);
          }, function (err) {
        ...
        key: "loadFeeStaus",
        value: function loadFeeStaus(id, stander, section) {
          var _this2 = this;

          this._feeModule.getStudentFeeDetails(id, stander, section).subscribe(function (res) {
            _this2.feeModule = res;

            _this2.feeModule.feeParticular.forEach(function (element) {
              ...
              _this2.Term1Fee = _this2.Term1Fee + element.Term1;
              _this2.Term2Fee = _this2.Term2Fee + element.Term12;
              _this2.Term1FeePaidAmt += element.Term1DueAmt;
              _this2.Term2FeePaidAmt += element.Term2DueAmt;
              _this2.Term1FeeDueAmt += element.Term1Paid;
              _this2.Term2FeeDueAmt += element.Term2Paid;
            });
          }, function (error) {
            console.log(error);
          });
    ...
    StudentFeeStatusComponent.ctorParameters = function () {
      return [{
    ...
    StudentFeeStatusComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-StudentFeeStatus',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./StudentFeeStatus.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/demo/pages/layout/StudentFeeStatus/StudentFeeStatus.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./StudentFeeStatus.component.css */
      "./src/app/demo/pages/layout/StudentFeeStatus/StudentFeeStatus.component.css"))["default"]]
  ...
  /***/
  function srcAppDemoPagesLayoutStudentFeeStatusStudentFeeStatusModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "StudentFeeStatusModule", function () {
      return StudentFeeStatusModule;
    });
    /* harmony import */
    ...
    var _StudentFeeStatus_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./StudentFeeStatus.component */
    "./src/app/demo/pages/layout/StudentFeeStatus/StudentFeeStatus.component.ts");
    /* harmony import */
    ...
    var _StudentFeeStatus_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./StudentFeeStatus-routing.module */
    "./src/app/demo/pages/layout/StudentFeeStatus/StudentFeeStatus-routing.module.ts");

    var StudentFeeStatusModule = function StudentFeeStatusModule() {
      _classCallCheck(this, StudentFeeStatusModule);
    };

    StudentFeeStatusModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      schemas: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["CUSTOM_ELEMENTS_SCHEMA"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], src_app_theme_shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"], _StudentFeeStatus_routing_module__WEBPACK_IMPORTED_MODULE_5__["StudentFeeStatusRoutingModule"]],
...
//# sourceMappingURL=default~StudentDashboard-StudentDashboard-module~StudentFeeStatus-StudentFeeStatus-module-es5.js.map