...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["AddFeePackaging-AddFeePackaging-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppDemoPagesFormElementsAddFeePackagingAddFeePackagingComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDemoPagesFormElementsAddFeePackagingAddFeePackagingRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AddFeePackagingRoutingModule", function () {
      return AddFeePackagingRoutingModule;
    });
    /* harmony import */
    ...
    var _AddFeePackaging_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./AddFeePackaging.component */
    ...
    var AddFeePackagingRoutingModule = function AddFeePackagingRoutingModule() {
      _classCallCheck(this, AddFeePackagingRoutingModule);
    };

    AddFeePackagingRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppDemoPagesFormElementsAddFeePackagingAddFeePackagingComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDemoPagesFormElementsAddFeePackagingAddFeePackagingComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AddFeePackagingComponent", function () {
      return AddFeePackagingComponent;
    });
    /* harmony import */
    ...
    var AddFeePackagingComponent = /*#__PURE__*/function () {
      function AddFeePackagingComponent(_classLevel, _feeServices, fb, toastr) {
        _classCallCheck(this, AddFeePackagingComponent);
      ...
      _createClass(AddFeePackagingComponent, [{
        key: "ngOnInit",
        ...
        value: function GetFeeTypes() {
          ...
          this._feeServices.getFeeTypes(this.selectedLevel).subscribe(function (data) {
            ...
            _this2.date = _this2.FeeTypes[0].term2From;
        ...
        key: "updateFeeTerms",
        value: function updateFeeTerms() {
          var _this4 = this;

          this._feeServices.UpdateTermsWise(this.FeeTypes).subscribe(function (data) {
            _this4.toastr.success("Term Fee Updated", "Updated Successfully");
          }, function (error) {
            _this4.toastr.error("Term Fee Updated Failed", error.error);
          });
        }
      }]);
    ...
    AddFeePackagingComponent.ctorParameters = function () {
      return [{
    ...
    AddFeePackagingComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-AddFeePackaging',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./AddFeePackaging.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/demo/pages/form-elements/AddFeePackaging/AddFeePackaging.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./AddFeePackaging.component.css */
      "./src/app/demo/pages/form-elements/AddFeePackaging/AddFeePackaging.component.css"))["default"]]
  ...
  /***/
  function srcAppDemoPagesFormElementsAddFeePackagingAddFeePackagingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AddFeePackagingModule", function () {
      return AddFeePackagingModule;
    });
    /* harmony import */
    ...
    var _AddFeePackaging_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./AddFeePackaging-routing.module */
    "./src/app/demo/pages/form-elements/AddFeePackaging/AddFeePackaging-routing.module.ts");
    /* harmony import */
    ...
    var AddFeePackagingModule = function AddFeePackagingModule() {
      _classCallCheck(this, AddFeePackagingModule);
    };

    AddFeePackagingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], src_app_theme_shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_6__["NgbDropdownModule"], ngx_bootstrap_datepicker__WEBPACK_IMPORTED_MODULE_7__["BsDatepickerModule"].forRoot(), _AddFeePackaging_routing_module__WEBPACK_IMPORTED_MODULE_5__["AddFeePackagingRoutingModule"]],
      declarations: [_AddFeePackaging_component__WEBPACK_IMPORTED_MODULE_3__["AddFeePackagingComponent"]]
    })], AddFeePackagingModule);
    /***/
  }
}]);
//# sourceMappingURL=AddFeePackaging-AddFeePackaging-module-es5.js.map